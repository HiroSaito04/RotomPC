    ...
    <Box sx={{ p: 3, bgcolor: "#f0f0f0", minHeight: "100vh" }}>
      ...
      >
        ...
        <Stack direction="row" spacing={1.5} flexWrap="wrap">
          ...
          <Button sx={primaryButton} onClick={handlePrint}>
            Export
          </Button>
      ...
      <Stack spacing={3} ref={printRef}>
        ...
        <Paper sx={paperStyle}>
          ...
          <Box sx={chartContainer}>
            <BarChart
              ...
              xAxis={[
                {
                  data: reportData.quarterlyEngagement.xAxis,
                  scaleType: "band",
                },
              ]}
              height={260}
        ...
        <Paper sx={paperStyle}>
          ...
          <Box sx={chartContainer}>
            <BarChart
              xAxis={[
                { scaleType: "band", data: reportData.monthlyVolume.months },
              ]}
              series={[
                {
                  data: reportData.monthlyVolume.posts,
                  label: "Articles",
                  color: "#1A1A1A",
                },
              ]}
          ...
          <Box sx={chartContainer}>
            <BarChart
              ...
              yAxis={[
                {
                  scaleType: "band",
                  data: reportData.contentPerformance.categories,
                },
              ]}
              series={[
                {
                  data: reportData.contentPerformance.values,
                  color: "#cc0000",
                },
              ]}
              height={260}
