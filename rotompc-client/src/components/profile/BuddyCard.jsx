        ...
        <div className="space-y-4 p-5 sm:p-6">
          ...
          <section className="rounded-2xl border-[3px] border-zinc-950 bg-pink-100 p-4 shadow-[4px_4px_0_#18181b]">
            ...
            <p className="mt-2 text-sm font-medium leading-6 text-zinc-700">
              Every successful pet gives +1 affection and costs 1 energy.
            </p>
          ...
          <section className="rounded-2xl border-[3px] border-zinc-950 bg-cyan-100 p-4 shadow-[4px_4px_0_#18181b]">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              <div className="rounded-xl border-2 border-zinc-950 bg-white p-3 text-center">
                <p className="text-lg font-black text-pink-500">−1</p>
              ...
              <div className="rounded-xl border-2 border-zinc-950 bg-white p-3 text-center">
                <p className="text-lg font-black text-blue-500">−10</p>
            ...
            <p className="mt-3 text-sm font-medium leading-6 text-zinc-700">
              When energy reaches zero, your Buddy leaves the active card and
              rests for two minutes.
            </p>
          </section>
          ...
          <section className="rounded-2xl border-[3px] border-zinc-950 bg-violet-100 p-4 shadow-[4px_4px_0_#18181b]">
            ...
            <p className="mt-2 text-sm font-medium leading-6 text-zinc-700">
              A resting Buddy cannot be petted, played with, or fed. The server
              controls the rest timer.
            </p>
          ...
          <section className="rounded-2xl border-[3px] border-zinc-950 bg-yellow-100 p-4 shadow-[4px_4px_0_#18181b]">
            ...
            <h3 className="mt-1 text-lg font-black uppercase text-zinc-950">
              Throw Berries To Feed
            </h3>

            <p className="mt-2 text-sm font-medium leading-6 text-zinc-700">
              Drag a berry from the Berry Bag and release it over your Buddy.
            </p>
            ...
            <div className="mt-3 rounded-xl border-2 border-zinc-950 bg-white p-3">
              ...
              <p className="mt-1 text-xs font-semibold text-zinc-500">
                A Buddy waking at 10 energy needs 3 berries to reach 100.
              </p>
            </div>
          </section>
          ...
          <section className="rounded-2xl border-[3px] border-zinc-950 bg-white p-4 shadow-[4px_4px_0_#18181b]">
            ...
            <div className="mt-4 grid grid-cols-3 gap-2">
              <div className="rounded-xl border-2 border-zinc-950 bg-zinc-100 p-3 text-center">
                <p className="text-xl font-black text-zinc-950">+1</p>
              ...
              <div className="rounded-xl border-2 border-zinc-950 bg-zinc-100 p-3 text-center">
                <p className="text-xl font-black text-zinc-950">+5</p>
              ...
              <div className="rounded-xl border-2 border-zinc-950 bg-zinc-100 p-3 text-center">
                <p className="text-xl font-black text-zinc-950">+10</p>
            ...
            <p className="mt-4 text-xs font-semibold leading-5 text-zinc-500">
              New trainers start with 5 berries. Re-liking or re-following the
              same target does not grant the reward again.
            </p>
          </section>
...
const BuddyCard = ({
  ...
  const triggerEffect = (effect) => {
    ...
    window.setTimeout(() => setActionEffect(null), 850);
  };
  ...
  const feedAfterThrow = async () => {
    ...
    try {
      ...
      setMessage(
        `${pokemon?.displayName || "Buddy"} ate the ${selectedBerry.displayName}!`,
      );
  ...
  if (loading) {
    return (
      <>
        ...
        {showRules && <BuddyRulesModal onClose={() => setShowRules(false)} />}
      </>
    );
  }
                  ...
                  >
                    ...
                    {actionEffect === "play" && (
                      <>
                        ...
                        <span className="absolute right-[22%] bottom-[18%] animate-bounce text-xl text-yellow-100 [animation-delay:220ms]">
                          ★
                        </span>
                      </>
                    )}
                ...
                <div className="mt-3 flex gap-1.5 overflow-x-auto pb-2">
                  {berries.map((berry, index) => (
                    <button
                      key={berry.name}
                      type="button"
                      onClick={() => setSelectedBerryIndex(index)}
                      ...
                      className={`
                          ...
                          ${
                            index === selectedBerryIndex
                              ? "-translate-y-0.5 ring-2 ring-yellow-300"
                ...
                >
                  {selectedBerry ? (
                    <button
                      ...
                      "
                      style={{
                        transform: `translate3d(${berryDrag.x}px, ${berryDrag.y}px, 0) scale(${
                          berryDrag.dragging
                            ? 1.15
                            : berryDrag.throwing
                              ? 0.58
